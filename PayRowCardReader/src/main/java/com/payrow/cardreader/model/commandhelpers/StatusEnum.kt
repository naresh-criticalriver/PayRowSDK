...
enum class StatusEnum(status: String, val detail: String) {
    ...
    STATUS_61("61", "Command successfully executed; 'XX' bytes of data are available and can be requested using GET RESPONSE"),
    ...
    STATUS_6501("6501", "Write error. Memory failure. There have been problems in writing or reading the EEPROM. Other hardware problems may also bring this error"),
    ...
    STATUS_6F00("6F00", "Command aborted - more exact diagnosis not possible (e.g., operating system error)"),
